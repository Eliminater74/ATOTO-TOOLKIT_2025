...
import androidx.navigation.NavDestination.Companion.hierarchy   // <-- important
...
sealed class Dest(val route: String, val label: String, val icon: ImageVector) {
    ...
    data object Settings  : Dest("settings",  "Settings",  Icons.Outlined.Settings) // placeholder
}

private val items = listOf(Dest.Quick, Dest.Launchers, Dest.Shizuku /*, Dest.Settings*/)
